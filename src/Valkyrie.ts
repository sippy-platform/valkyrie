...
export const viArrowPointer: {
  ...
  name: 'arrow_pointer',
  data: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor"><path d="M3.44 1.07a.75.75 0 0 1 .8.12l8.5 7.5a.75.75 0 0 1-.49 1.31H8.2l1.74 3.95a.75.75 0 0 1-1.38.6l-1.7-3.88-2.53 3.06A.75.75 0 0 1 3 13.25V1.75c0-.3.17-.56.44-.68ZM4.5 3.4v7.75l1.97-2.39a.75.75 0 0 1 .58-.27h3.22L4.5 3.41Z"/></svg>`
};
...
export const viBlf: {
  ...
  name: 'blf',
  data: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor"><path d="M4 5.5a2.5 2.5 0 0 0 0 5h8a2.5 2.5 0 0 0 2.39-1.75H10a.75.75 0 0 1 0-1.5h4.39A2.5 2.5 0 0 0 12 5.5H4ZM0 8a4 4 0 0 1 4-4h8a4 4 0 0 1 0 8H4a4 4 0 0 1-4-4Z"/></svg>`
};
export const viBold: {
  name: 'bold';
  data: string;
...
export const viChartPie: {
  ...
  name: 'chart_pie',
  data: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor"><path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0Zm-1.54.75H8.23l-5.19 3.46a6.49 6.49 0 0 0 11.42-3.46Zm0-1.5a6.5 6.5 0 0 0-5.71-5.7v5.7h5.7Zm-7.21-5.7a6.5 6.5 0 0 0-5.04 9.4L7.25 7.6V1.54Z"/></svg>`
};
...
export const viEnvelope: {
  ...
  name: 'envelope',
  data: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor"><path d="M0 3.75C0 2.78.78 2 1.75 2h12.5c.97 0 1.75.78 1.75 1.75v8.5c0 .97-.78 1.75-1.75 1.75H1.75C.78 14 0 13.22 0 12.25v-8.5Zm1.66-.23 6.18 4.9c.1.07.22.07.32 0l6.18-4.9a.25.25 0 0 0-.09-.02H1.75c-.03 0-.06 0-.09.02ZM14.5 5.3 9.09 9.6c-.64.5-1.54.5-2.18 0L1.5 5.3v6.95c0 .14.11.25.25.25h12.5c.14 0 .25-.11.25-.25V5.3Z"/></svg>`
};
...
export const viLaptop: {
  ...
  name: 'laptop',
  data: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor"><path d="M2.75 3.5h10.5c.14 0 .25.11.25.25V12h-11V3.75c0-.14.11-.25.25-.25ZM15 12V3.75C15 2.78 14.22 2 13.25 2H2.75C1.78 2 1 2.78 1 3.75V12H.75a.75.75 0 0 0-.75.75v.05c0 .66.54 1.2 1.2 1.2h13.6c.66 0 1.2-.54 1.2-1.2v-.05a.75.75 0 0 0-.75-.75H15Z"/></svg>`
};
...
export const viNetwork: {
  ...
  name: 'network',
  data: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor"><path d="M8 1.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z"/><path d="M13.5 6a2.5 2.5 0 1 0-2.22-1.34l-1.4 1.4a3.48 3.48 0 0 0-4.36.47l-.6-.38A2.5 2.5 0 1 0 4.1 7.4l.6.39a3.5 3.5 0 0 0 4.87 4.32l1.52 1.85a1.5 1.5 0 1 0 1.16-.95l-1.51-1.85a3.48 3.48 0 0 0 .2-4.06l1.4-1.4c.34.19.73.29 1.15.29Zm0-1.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2Zm-10 1a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM10 9a2 2 0 1 1-4 0 2 2 0 0 1 4 0Z"/></svg>`
};
...
export const viSwatchbook: {
  ...
  name: 'swatchbook',
  data: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor"><path d="M3.5 13.5a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z"/><path d="M7 4V2a2 2 0 0 0-2-2H2a2 2 0 0 0-2 2v10.5A3.5 3.5 0 0 0 3.5 16H14a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2h-2.09l-1.49 1.5H14c.28 0 .5.22.5.5v3a.5.5 0 0 1-.5.5H6.44l-.32.32 7.28-7.31c.78-.79.78-2.06 0-2.84l-2.12-2.13a2 2 0 0 0-2.83 0L7 3.99ZM1.5 5.5h4V8h-4V5.5Zm0-1.5V2c0-.28.22-.5.5-.5h3c.28 0 .5.22.5.5v2h-4ZM7 11.81v-5.7L9.51 3.6c.2-.2.51-.2.7 0l2.13 2.13c.2.2.2.53 0 .73L7 11.81ZM1.5 9.5h4v3a2 2 0 1 1-4 0v-3Z"/></svg>`
};
...
export const viTag: {
  ...
  name: 'tag',
  data: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor"><path d="M5 6a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z"/><path d="M2.75 1C1.78 1 1 1.78 1 2.75v4.09c0 .46.18.9.51 1.23l6.5 6.5c.69.69 1.8.69 2.48 0l4.1-4.1c.67-.67.68-1.76.02-2.45L8.33 1.53A1.75 1.75 0 0 0 7.08 1H2.75ZM2.5 2.75c0-.14.11-.25.25-.25h4.33c.06 0 .13.03.18.08l6.27 6.48c.1.1.1.26 0 .35l-4.1 4.1c-.1.1-.26.1-.36 0l-6.5-6.5a.25.25 0 0 1-.07-.17V2.75Z"/></svg>`
};
...
export const viVideo: {
  ...
  name: 'video',
  data: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor"><path fill-rule="evenodd" d="M1.75 3.5a.25.25 0 0 0-.25.25v8.5c0 .14.11.25.25.25h7c.14 0 .25-.11.25-.25v-8.5a.25.25 0 0 0-.25-.25h-7ZM0 3.75C0 2.78.78 2 1.75 2h7c.97 0 1.75.78 1.75 1.75v1.04l4.41-2.21a.75.75 0 0 1 1.09.67v9.5a.75.75 0 0 1-1.09.67l-4.41-2.2v1.03c0 .97-.78 1.75-1.75 1.75h-7C.78 14 0 13.22 0 12.25v-8.5Zm10.5 5.79 4 2V4.46l-4 2v3.08Z"/></svg>`
};
