...
export const viSpy: {
  ...
  name: 'spy',
  data: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 16" fill="currentColor"><path fill-rule="evenodd" d="M14.76 3.37a3.59 3.59 0 0 0-.9-1.5l-.45-.46a1.44 1.44 0 0 0-1.91-.1c-.88.7-2.12.7-3 0a1.44 1.44 0 0 0-1.9.1l-.46.45c-.42.42-.73.94-.9 1.5l-.8 2.65C2.88 6.38 2 6.9 2 7.5c0 1.1 3.03 2 8 2 4.97 0 8-.9 8-2 0-.6-.87-1.12-2.45-1.5l-.79-2.63Zm-9.13 3.9L6.68 3.8c.1-.33.28-.63.52-.88l.1-.1c.18-.18.46-.2.67-.06a3.9 3.9 0 0 0 4.06 0c.21-.13.5-.12.67.06l.1.1c.24.25.42.55.52.88l1.05 3.47.77.18c.05.02.05.09 0 .1-1.2.27-2.94.45-5.14.45-2.2 0-3.93-.18-5.14-.45-.05-.01-.05-.08 0-.1l.77-.18Zm5.91 7.5a1.58 1.58 0 0 1-.76-.83l-.55-1.36a.24.24 0 0 0-.13-.14.26.26 0 0 0-.2 0 .24.24 0 0 0-.13.14l-.55 1.36a1.58 1.58 0 0 1-1.73.98l-1.41-.24a2 2 0 0 1-1.51-1.19l-.43-1a1.72 1.72 0 0 1 1.96-2.36l3.44.77a2 2 0 0 0 .92-.01l2.91-.73a2 2 0 0 1 2.32 2.72l-.26.61a2 2 0 0 1-1.5 1.19l-1.42.24c-.33.05-.67 0-.97-.15Zm.67-1.34h.05l1.41-.23a.5.5 0 0 0 .38-.3l.26-.61a.5.5 0 0 0-.57-.68l-2.07.52.5 1.25c0 .02.02.04.04.05ZM5.77 11.6a.22.22 0 0 0-.25.3l.43 1c.07.16.2.27.38.3l1.4.24a.09.09 0 0 0 .1-.06l.49-1.22-2.55-.56Z"/></svg>`
};
export const viStar: {
  name: 'star';
  data: string;
