...
export const viHeartHalf: {
  ...
  name: 'heart_half',
  data: `<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M6.5 3.921l-.682-.682A2.53 2.53 0 001.5 5.03v.373c0 .817.325 1.601.903 2.18L6.5 11.678V3.92zM8 3.3L6.879 2.179A4.03 4.03 0 000 5.029v.373c0 1.215.483 2.38 1.342 3.24l5.95 5.95A.42.42 0 008 14.288V3.3z"/></svg>`
};
