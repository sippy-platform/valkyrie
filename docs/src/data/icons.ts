...
const icons = [
  ...
  {
    component: 'viExpandRectangle',
    categories: ["media"],
    tags: ["expand view"],
    slug: 'expand-rectangle',
    icon: viExpandRectangle
  },
  {
    component: 'viExpand',
    categories: ["media"],
  ...
  {
    component: 'viPhoneArrowRight',
    categories: ["office-tools","communication"],
    tags: ["telephone","call","forward"],
    slug: 'phone-arrow-right',
    icon: viPhoneArrowRight
  },
  {
