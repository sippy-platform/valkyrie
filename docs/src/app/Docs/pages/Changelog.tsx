  ...
  return (
    <Stack gap={5}>
      ...
      <Release
        ...
        date="19 May 2025"
        newIcons={['arrow-right-to-bracket-clock', 'align-content-center', 'align-content-end', 'align-content-start', 'list-bar-chart']}
      />
      <Release
        name="Valkyrie 1.0 alpha 56"
        version="1.0.0-alpha.56"
        date="31 March 2025"
        newIcons={['signal-slash', 'signal-fair', 'signal-weak', 'signal-moderate', 'signal-good', 'signal-strong']}
      />
