...
export const viGooglePlay: {
  ...
  name: 'google_play',
  data: `<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="vi" viewBox="0 0 16 16"><path d="m10.959 11.666-7.36 4.089c-.793.44-1.709.19-2.214-.434L8 8.707zM7.293 8l-6.291 6.29L1 14.226V1.774l.002-.065zm7.513-1.53c1.2.666 1.2 2.392 0 3.06l-2.938 1.631L8.707 8l3.161-3.162zM1.385.678A1.75 1.75 0 0 1 3.6.245l7.359 4.088L8 7.293z"/></svg>`,
};
export const viGrid: {
  name: 'grid';
  data: string;
...
export const viPhoneHangup: {
  ...
  name: 'phone_hangup',
  data: `<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="vi" viewBox="0 0 16 16"><path d="M8.316 4.513c1.91.058 3.787.694 5.885 1.85l.423.237.076.05 1 .75a.75.75 0 0 1 .198.978l-1.75 3a.75.75 0 0 1-.918.322l-3.25-1.25a.75.75 0 0 1-.472-.806l.162-1.141C9 8.283 8.49 8.187 8 8.187s-1 .096-1.67.316l.162 1.14a.75.75 0 0 1-.472.807L2.77 11.7a.75.75 0 0 1-.917-.322l-1.75-3a.75.75 0 0 1 .185-.969l.355-.276c.43-.336.896-.652 1.4-.914C4.287 5.05 6.276 4.45 8.316 4.513m-.045 1.5c-1.696-.052-3.425.437-5.536 1.536-.346.18-.68.398-1.006.641l1.096 1.88 2.098-.806-.165-1.158a.75.75 0 0 1 .478-.808C6.27 6.91 7.118 6.688 8 6.688s1.73.222 2.764.61a.75.75 0 0 1 .478.808l-.166 1.158 2.098.806 1.092-1.872-.424-.317C11.703 6.656 9.96 6.064 8.27 6.013"/></svg>`,
};
...
export const viPhoneXmark: {
  ...
  name: 'phone_xmark',
  data: `<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="vi" viewBox="0 0 16 16"><path d="M4.987 0a.75.75 0 0 1 .666.382l2.25 4c.182.323.1.732-.192.96L5.864 6.777c.255.715.725 1.422 1.337 2.026.608.598 1.322 1.06 2.027 1.324l1.43-1.838.093-.1a.75.75 0 0 1 .867-.092l4 2.25a.75.75 0 0 1 .37.783l-.75 4.25a.75.75 0 0 1-.738.62H13c-3.25 0-6.494-1.683-8.905-4.095C1.683 9.494 0 6.251 0 3V1.5A.75.75 0 0 1 .62.762l4.25-.75zM1.5 2.128V3c0 2.75 1.442 5.632 3.655 7.845S10.251 14.5 13 14.5h.871l.548-3.107-2.974-1.673-1.353 1.741a.75.75 0 0 1-.774.267c-1.152-.288-2.276-.976-3.17-1.857-.893-.88-1.607-2.002-1.88-3.206a.75.75 0 0 1 .271-.757l1.74-1.354L4.606 1.58zM14.72.22a.75.75 0 1 1 1.06 1.06L13.56 3.5l2.22 2.22a.75.75 0 1 1-1.06 1.06L12.5 4.56l-2.22 2.22a.75.75 0 0 1-1.06-1.06l2.22-2.22-2.22-2.22A.75.75 0 1 1 10.28.22l2.22 2.22z"/><path d="M4.987 0a.75.75 0 0 1 .666.383l2.25 4c.182.323.1.732-.192.96L5.864 6.778c.255.714.725 1.422 1.337 2.026.608.598 1.322 1.06 2.027 1.324l1.43-1.838.093-.1a.75.75 0 0 1 .867-.092l4 2.25a.75.75 0 0 1 .37.783l-.75 4.25a.75.75 0 0 1-.738.62H13c-3.25 0-6.494-1.683-8.905-4.095C1.683 9.495 0 6.251 0 3.001V1.5A.75.75 0 0 1 .62.763l4.25-.75zM1.5 2.13V3c0 2.749 1.442 5.632 3.655 7.845S10.251 14.5 13 14.5h.871l.548-3.107-2.974-1.673-1.353 1.74a.75.75 0 0 1-.774.267c-1.152-.288-2.276-.976-3.17-1.856-.893-.88-1.607-2.002-1.88-3.206a.75.75 0 0 1 .271-.757l1.74-1.354L4.606 1.58z"/><path d="M14.72.22a.75.75 0 0 1 1.06 1.06L13.56 3.5l2.22 2.22a.75.75 0 0 1-1.06 1.06L12.5 4.56l-2.22 2.22a.75.75 0 1 1-1.06-1.06l2.22-2.22-2.22-2.22A.75.75 0 1 1 10.28.22l2.22 2.22z"/></svg>`,
};
...
export type IValkyrieNameSubset<T extends Readonly<IValkyrie[]>> =
  T[number]['name'];
export const valkyrieSet = [
  ...
  viPersonXmark,
  viPerson,
  viPhoneArrowBounceLeft,
  viPhoneArrowBounceRight,
