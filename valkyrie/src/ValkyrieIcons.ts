...
export const viCalendarDay: {
  ...
  name: 'calendar_day',
  data: `<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="vi" viewBox="0 0 16 16"><path d="M13.25 1c.966 0 1.75.784 1.75 1.75v10.5A1.75 1.75 0 0 1 13.25 15H2.75A1.75 1.75 0 0 1 1 13.25V2.75C1 1.784 1.784 1 2.75 1zM2.5 13.25c0 .138.112.25.25.25h10.5a.25.25 0 0 0 .25-.25V5.5h-11zm9-3.75a.5.5 0 0 1 .5.5v1.5a.5.5 0 0 1-.5.5h-7a.5.5 0 0 1-.5-.5V10a.5.5 0 0 1 .5-.5zm0-2.5a.5.5 0 0 1 .5.5V8a.5.5 0 0 1-.5.5h-7A.5.5 0 0 1 4 8v-.5a.5.5 0 0 1 .5-.5zM2.75 2.5a.25.25 0 0 0-.25.25V4h11V2.75a.25.25 0 0 0-.25-.25z"/></svg>`,
};
...
export const viCalendarRange: {
  ...
  name: 'calendar_range',
  data: `<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="vi" viewBox="0 0 16 16"><path d="M13.25 1c.966 0 1.75.784 1.75 1.75v10.5A1.75 1.75 0 0 1 13.25 15H2.75A1.75 1.75 0 0 1 1 13.25V2.75C1 1.784 1.784 1 2.75 1zM2.5 13.25c0 .138.112.25.25.25h10.5a.25.25 0 0 0 .25-.25V5.5h-11zm6-3.25a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-4a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5zm3-3a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-4a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5zM2.75 2.5a.25.25 0 0 0-.25.25V4h11V2.75a.25.25 0 0 0-.25-.25z"/></svg>`,
};
export const viCalendarStars: {
  ...
  name: 'calendar_stars',
  data: `<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="vi" viewBox="0 0 16 16"><path d="M13.25 1c.966 0 1.75.784 1.75 1.75v10.5A1.75 1.75 0 0 1 13.25 15H2.75A1.75 1.75 0 0 1 1 13.25V2.75C1 1.784 1.784 1 2.75 1zM2.5 13.25c0 .138.112.25.25.25h10.5a.25.25 0 0 0 .25-.25V5.5h-11zm8-4.25a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 0 1H11v.5a.5.5 0 0 1-1 0V11h-.5a.5.5 0 0 1 0-1h.5v-.5a.5.5 0 0 1 .5-.5m-5-2a.5.5 0 0 1 .5.5V8h.5a.5.5 0 0 1 0 1H6v.5a.5.5 0 0 1-1 0V9h-.5a.5.5 0 0 1 0-1H5v-.5a.5.5 0 0 1 .5-.5M2.75 2.5a.25.25 0 0 0-.25.25V4h11V2.75a.25.25 0 0 0-.25-.25z"/></svg>`,
};
export const viCalendarWeek: {
  ...
  name: 'calendar_week',
  data: `<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="vi" viewBox="0 0 16 16"><path d="M13.25 1c.966 0 1.75.784 1.75 1.75v10.5A1.75 1.75 0 0 1 13.25 15H2.75A1.75 1.75 0 0 1 1 13.25V2.75C1 1.784 1.784 1 2.75 1zM2.5 13.25c0 .138.112.25.25.25h10.5a.25.25 0 0 0 .25-.25V5.5h-11zM5 7a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-.5a.5.5 0 0 1-.5-.5v-4a.5.5 0 0 1 .5-.5zm3.25 0a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-.5a.5.5 0 0 1-.5-.5v-4a.5.5 0 0 1 .5-.5zm3.25 0a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5H11a.5.5 0 0 1-.5-.5v-4A.5.5 0 0 1 11 7zM2.75 2.5a.25.25 0 0 0-.25.25V4h11V2.75a.25.25 0 0 0-.25-.25z"/></svg>`,
};
export const viCalendar: {
  ...
  name: 'calendar',
  data: `<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="vi" viewBox="0 0 16 16"><path d="M13.25 1c.966 0 1.75.784 1.75 1.75v10.5A1.75 1.75 0 0 1 13.25 15H2.75A1.75 1.75 0 0 1 1 13.25V2.75C1 1.784 1.784 1 2.75 1zM2.5 13.25c0 .138.112.25.25.25h10.5a.25.25 0 0 0 .25-.25V5.5h-11zM5 10a1 1 0 1 1 0 2 1 1 0 0 1 0-2m3 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2M5 7a1 1 0 1 1 0 2 1 1 0 0 1 0-2m3 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2m3 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2M2.75 2.5a.25.25 0 0 0-.25.25V4h11V2.75a.25.25 0 0 0-.25-.25z"/></svg>`,
};
...
export const viCircleRadio: {
  name: 'circle_radio';
  data: string;
} = {
  name: 'circle_radio',
  data: `<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="vi" viewBox="0 0 16 16"><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0m0 1.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13M8 4a4 4 0 1 1 0 8 4 4 0 0 1 0-8"/></svg>`,
};
